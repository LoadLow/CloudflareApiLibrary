 ...
 * @author LoadLow
 */
public class ToggleIPV6Support extends CloudflareRequest {

    public ToggleIPV6Support(CloudflareAccess api, String domain, EnableOption option) {
        super(api, CloudflareValue.IPV6);
        add("z", domain);
        add("v", option.opt);
    }
